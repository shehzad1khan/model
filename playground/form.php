              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form>
                  ...
                  <div class="form-outline mb-4">
                    <input type="email" id="form2Example17" class="form-control form-control-lg" placeholder="email or username" />
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #fff;">Don't have an account? <a href="#!"
